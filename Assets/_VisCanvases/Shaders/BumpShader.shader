Shader "Custom/BumpShader" {
    Properties{
     ...
     SubShader{
            ...
            //#else 
            //            float3 WorldToDataSpace(float3 localPos) {
            //                return float3(0, 0, 0);
            //            }
            //#endif
                    ...
                    float3 _centerPos = float3(0, 0, 0);
                    float3 _normalVec = float3(1, 0, 0);
                    ...
                    void surf(Input IN, inout SurfaceOutputStandard o) {
                        float3 dataNorm = _normalVec;
                        float3 A_dataPos = _centerPos;
