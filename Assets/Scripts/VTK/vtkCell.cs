...
public int GetCellType() {
	...
	API_vtkCell.GetCellType_0(returnPointer.GetPtr(), this);
...
public int GetCellDimension() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.GetCellDimension_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int IsLinear() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.IsLinear_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int RequiresInitialization() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.RequiresInitialization_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int IsExplicitCell() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.IsExplicitCell_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int RequiresExplicitFaceRepresentation() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.RequiresExplicitFaceRepresentation_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public IntPtr GetFaces() {
	...
	API_vtkCell.GetFaces_0(returnPointer.GetPtr(), this);
...
public vtkPoints GetPoints() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetPoints_0(returnPointer.GetPtr(), this);
...
public long GetNumberOfPoints() {
	...
	API_vtkCell.GetNumberOfPoints_0(returnPointer.GetPtr(), this);
...
public int GetNumberOfEdges() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.GetNumberOfEdges_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int GetNumberOfFaces() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.GetNumberOfFaces_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public vtkIdList GetPointIds() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetPointIds_0(returnPointer.GetPtr(), this);
...
public long GetPointId(int /*(int)*/ ptId) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkCell.GetPointId_0(returnPointer.GetPtr(), this, ptId);
	return (long)returnPointer;
}
...
public vtkCell GetEdge(int /*(int)*/ edgeId) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetEdge_0(returnPointer.GetPtr(), this, edgeId);
...
public vtkCell GetFace(int /*(int)*/ faceId) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetFace_0(returnPointer.GetPtr(), this, faceId);
	return (vtkCell)(IntPtr)returnPointer;
}
...
public int CellBoundary(int /*(int)*/ subId, double /*(double[3])*/ []pcoords, vtkIdList /*(vtkIdList*)*/ pts) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.CellBoundary_0(returnPointer.GetPtr(), this, subId, pcoords, pts);
	return (int)returnPointer;
}
...
public int EvaluatePosition(double /*(double[3])*/ []x, IntPtr /*(double*)*/ closestPoint, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double&)*/ dist2, IntPtr /*(double*)*/ weights) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.EvaluatePosition_0(returnPointer.GetPtr(), this, x, closestPoint, subId, pcoords, dist2, weights);
	return (int)returnPointer;
}
...
public int IntersectWithLine(double /*(double[3])*/ []p1, double /*(double[3])*/ []p2, double /*(double)*/ tol, IntPtr /*(double&)*/ t, double /*(double[3])*/ []x, double /*(double[3])*/ []pcoords, IntPtr /*(int&)*/ subId) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.IntersectWithLine_0(returnPointer.GetPtr(), this, p1, p2, tol, t, x, pcoords, subId);
	return (int)returnPointer;
}
...
public int Triangulate(int /*(int)*/ index, vtkIdList /*(vtkIdList*)*/ ptIds, vtkPoints /*(vtkPoints*)*/ pts) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.Triangulate_0(returnPointer.GetPtr(), this, index, ptIds, pts);
	return (int)returnPointer;
}
...
public IntPtr GetBounds() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetBounds_1(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public double GetLength2() {
	...
	API_vtkCell.GetLength2_0(returnPointer.GetPtr(), this);
...
public int GetParametricCenter(double /*(double[3])*/ []pcoords) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.GetParametricCenter_0(returnPointer.GetPtr(), this, pcoords);
	return (int)returnPointer;
}
...
public double GetParametricDistance(double /*(double[3])*/ []pcoords) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkCell.GetParametricDistance_0(returnPointer.GetPtr(), this, pcoords);
	return (double)returnPointer;
}
...
public int IsPrimaryCell() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkCell.IsPrimaryCell_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public IntPtr GetParametricCoords() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkCell.GetParametricCoords_0(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
