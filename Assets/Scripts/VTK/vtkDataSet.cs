...
public long GetNumberOfPoints() {
	...
	API_vtkDataSet.GetNumberOfPoints_0(returnPointer.GetPtr(), this);
...
public long GetNumberOfCells() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.GetNumberOfCells_0(returnPointer.GetPtr(), this);
	return (long)returnPointer;
}
...
public IntPtr GetPoint(long /*(vtkIdType)*/ ptId) {
	...
	API_vtkDataSet.GetPoint_0(returnPointer.GetPtr(), this, ptId);
...
public vtkCellIterator NewCellIterator() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.NewCellIterator_0(returnPointer.GetPtr(), this);
...
public vtkCell GetCell(long /*(vtkIdType)*/ cellId) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetCell_0(returnPointer.GetPtr(), this, cellId);
...
public int GetCellType(long /*(vtkIdType)*/ cellId) {
	...
	API_vtkDataSet.GetCellType_0(returnPointer.GetPtr(), this, cellId);
...
public long FindPoint(double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.FindPoint_0(returnPointer.GetPtr(), this, x, y, z);
	return (long)returnPointer;
}
...
public long FindPoint(double /*(double[3])*/ []x) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.FindPoint_1(returnPointer.GetPtr(), this, x);
	return (long)returnPointer;
}
...
public long FindCell(double /*(double[3])*/ []x, vtkCell /*(vtkCell*)*/ cell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ weights) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.FindCell_0(returnPointer.GetPtr(), this, x, cell, cellId, tol2, subId, pcoords, weights);
	return (long)returnPointer;
}
...
public long FindCell(double /*(double[3])*/ []x, vtkCell /*(vtkCell*)*/ cell, vtkGenericCell /*(vtkGenericCell*)*/ gencell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ weights) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.FindCell_1(returnPointer.GetPtr(), this, x, cell, gencell, cellId, tol2, subId, pcoords, weights);
	return (long)returnPointer;
}
...
public vtkCell FindAndGetCell(double /*(double[3])*/ []x, vtkCell /*(vtkCell*)*/ cell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ weights) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.FindAndGetCell_0(returnPointer.GetPtr(), this, x, cell, cellId, tol2, subId, pcoords, weights);
	return (vtkCell)(IntPtr)returnPointer;
}
...
public ulong GetMTime() {
	...
	API_vtkDataSet.GetMTime_0(returnPointer.GetPtr(), this);
...
public vtkCellData GetCellData() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetCellData_0(returnPointer.GetPtr(), this);
...
public vtkPointData GetPointData() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetPointData_0(returnPointer.GetPtr(), this);
...
public IntPtr GetBounds() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetBounds_0(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetCenter() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetCenter_0(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public double GetLength() {
	...
	API_vtkDataSet.GetLength_0(returnPointer.GetPtr(), this);
...
public IntPtr GetScalarRange() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetScalarRange_1(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public int GetMaxCellSize() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkDataSet.GetMaxCellSize_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public ulong GetActualMemorySize() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new ulong(), return_elements);
	API_vtkDataSet.GetActualMemorySize_0(returnPointer.GetPtr(), this);
	return (ulong)returnPointer;
}
...
public int GetDataObjectType() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkDataSet.GetDataObjectType_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public int CheckAttributes() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkDataSet.CheckAttributes_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public vtkFieldData GetAttributesAsFieldData(int /*(int)*/ type) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetAttributesAsFieldData_0(returnPointer.GetPtr(), this, type);
...
public long GetNumberOfElements(int /*(int)*/ type) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataSet.GetNumberOfElements_0(returnPointer.GetPtr(), this, type);
	return (long)returnPointer;
}
...
public bool HasAnyGhostCells() {
	...
	API_vtkDataSet.HasAnyGhostCells_0(returnPointer.GetPtr(), this);
...
public bool HasAnyGhostPoints() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new bool(), return_elements);
	API_vtkDataSet.HasAnyGhostPoints_0(returnPointer.GetPtr(), this);
	return (bool)returnPointer;
}
...
public bool HasAnyBlankCells() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new bool(), return_elements);
	API_vtkDataSet.HasAnyBlankCells_0(returnPointer.GetPtr(), this);
	return (bool)returnPointer;
}
...
public bool HasAnyBlankPoints() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new bool(), return_elements);
	API_vtkDataSet.HasAnyBlankPoints_0(returnPointer.GetPtr(), this);
	return (bool)returnPointer;
}
...
public vtkUnsignedCharArray GetPointGhostArray() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetPointGhostArray_0(returnPointer.GetPtr(), this);
...
public vtkUnsignedCharArray AllocatePointGhostArray() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.AllocatePointGhostArray_0(returnPointer.GetPtr(), this);
	return (vtkUnsignedCharArray)(IntPtr)returnPointer;
}
...
public vtkUnsignedCharArray GetCellGhostArray() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.GetCellGhostArray_0(returnPointer.GetPtr(), this);
	return (vtkUnsignedCharArray)(IntPtr)returnPointer;
}
...
public vtkUnsignedCharArray AllocateCellGhostArray() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataSet.AllocateCellGhostArray_0(returnPointer.GetPtr(), this);
	return (vtkUnsignedCharArray)(IntPtr)returnPointer;
}
