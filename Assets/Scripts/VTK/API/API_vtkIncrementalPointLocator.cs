...
bool FindClosestInsertedPoint_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, double /*(double[3])*/ []x);
...
bool InitPointInsertion_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, IntPtr /*(vtkPoints*)*/ newPts, double /*(double[6])*/ []bounds);
...
bool InitPointInsertion_1(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, IntPtr /*(vtkPoints*)*/ newPts, double /*(double[6])*/ []bounds, long /*(vtkIdType)*/ estSize);
...
bool IsInsertedPoint_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool IsInsertedPoint_1(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, double /*(double[3])*/ []x);
...
bool InsertUniquePoint_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkIdType&)*/ ptId);
...
bool InsertNextPoint_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIncrementalPointLocator*)*/ callingObject, double /*(double[3])*/ []x);
