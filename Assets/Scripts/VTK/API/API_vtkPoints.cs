...
bool vtkPoints_New_0(IntPtr /*(vtkPoints**)*/ return_value, int /*(int)*/ dataType);

// static vtkPoints* New()
// static vtkPoints *New()
[DllImport("vtkplugin", EntryPoint="vtkPoints_New_1")] public static extern 
bool vtkPoints_New_1(IntPtr /*(vtkPoints**)*/ return_value);
...
bool vtkPoints_InsertPoint_2(IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ id, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool vtkPoints_InsertPoints_0(IntPtr /*(vtkPoints*)*/ callingObject, IntPtr /*(vtkIdList*)*/ dstIds, IntPtr /*(vtkIdList*)*/ srcIds, IntPtr /*(vtkPoints*)*/ source);
...
bool vtkPoints_InsertPoints_1(IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ dstStart, long /*(vtkIdType)*/ n, long /*(vtkIdType)*/ srcStart, IntPtr /*(vtkPoints*)*/ source);

// vtkIdType InsertNextPoint(const float x[3])
// vtkIdType InsertNextPoint(const float x[3])
[DllImport("vtkplugin", EntryPoint="vtkPoints_InsertNextPoint_0")] public static extern 
bool vtkPoints_InsertNextPoint_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, float /*(float[3])*/ []x);

// vtkIdType InsertNextPoint(const double x[3])
// vtkIdType InsertNextPoint(const double x[3])
[DllImport("vtkplugin", EntryPoint="vtkPoints_InsertNextPoint_1")] public static extern 
bool vtkPoints_InsertNextPoint_1(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, double /*(double[3])*/ []x);

// vtkIdType InsertNextPoint(double x, double y, double z)
// vtkIdType InsertNextPoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkPoints_InsertNextPoint_2")] public static extern 
bool vtkPoints_InsertNextPoint_2(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);

// void SetNumberOfPoints(vtkIdType numPoints)
// void SetNumberOfPoints(vtkIdType numPoints)
[DllImport("vtkplugin", EntryPoint="vtkPoints_SetNumberOfPoints_0")] public static extern 
bool vtkPoints_SetNumberOfPoints_0(IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ numPoints);

// int Resize(vtkIdType numPoints)
// int Resize(vtkIdType numPoints)
[DllImport("vtkplugin", EntryPoint="vtkPoints_Resize_0")] public static extern 
bool vtkPoints_Resize_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ numPoints);

// void GetPoints(vtkIdList * ptId, vtkPoints * fp)
// void GetPoints(vtkIdList *ptId, vtkPoints *fp)
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetPoints_0")] public static extern 
bool vtkPoints_GetPoints_0(IntPtr /*(vtkPoints*)*/ callingObject, IntPtr /*(vtkIdList*)*/ ptId, IntPtr /*(vtkPoints*)*/ fp);

// virtual void ComputeBounds()
// virtual void ComputeBounds()
[DllImport("vtkplugin", EntryPoint="vtkPoints_ComputeBounds_0")] public static extern 
bool vtkPoints_ComputeBounds_0(IntPtr /*(vtkPoints*)*/ callingObject);

// double* GetBounds()
// double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetBounds_0")] public static extern 
bool vtkPoints_GetBounds_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);

// void GetBounds(double bounds[6])
// void GetBounds(double bounds[6])
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetBounds_1")] public static extern 
bool vtkPoints_GetBounds_1(IntPtr /*(vtkPoints*)*/ callingObject, double /*(double[6])*/ []bounds);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetMTime_0")] public static extern 
bool vtkPoints_GetMTime_0(IntPtr /*(vtkMTimeType*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);

// void Modified()
// void Modified()
[DllImport("vtkplugin", EntryPoint="vtkPoints_Modified_0")] public static extern 
bool vtkPoints_Modified_0(IntPtr /*(vtkPoints*)*/ callingObject);
