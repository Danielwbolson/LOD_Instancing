...
bool vtkUnstructuredGridBase_GetDataObjectType_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject);
...
bool vtkUnstructuredGridBase_Allocate_0(IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, long /*(vtkIdType)*/ numCells, int /*(int)*/ extSize);

// void DeepCopy(vtkDataObject * src)
// void DeepCopy(vtkDataObject *src)
[DllImport("vtkplugin", EntryPoint="vtkUnstructuredGridBase_DeepCopy_0")] public static extern 
bool vtkUnstructuredGridBase_DeepCopy_0(IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, IntPtr /*(vtkDataObject*)*/ src);
...
bool vtkUnstructuredGridBase_InsertNextCell_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, int /*(int)*/ type, long /*(vtkIdType)*/ npts, IntPtr /*(vtkIdType*)*/ ptIds);
...
bool vtkUnstructuredGridBase_InsertNextCell_1(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, int /*(int)*/ type, IntPtr /*(vtkIdList*)*/ ptIds);
...
bool vtkUnstructuredGridBase_InsertNextCell_2(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, int /*(int)*/ type, long /*(vtkIdType)*/ npts, IntPtr /*(vtkIdType*)*/ ptIds, long /*(vtkIdType)*/ nfaces, IntPtr /*(vtkIdType*)*/ faces);
...
bool vtkUnstructuredGridBase_ReplaceCell_0(IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, long /*(vtkIdType)*/ cellId, int /*(int)*/ npts, IntPtr /*(vtkIdType*)*/ pts);
...
bool vtkUnstructuredGridBase_GetIdsOfCellsOfType_0(IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject, int /*(int)*/ type, IntPtr /*(vtkIdTypeArray*)*/ array);

// virtual int IsHomogeneous()
// virtual int IsHomogeneous()
[DllImport("vtkplugin", EntryPoint="vtkUnstructuredGridBase_IsHomogeneous_0")] public static extern 
bool vtkUnstructuredGridBase_IsHomogeneous_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkUnstructuredGridBase*)*/ callingObject);
...
bool vtkUnstructuredGridBase_GetData_0(IntPtr /*(vtkUnstructuredGridBase**)*/ return_value, IntPtr /*(vtkInformation*)*/ info);
...
bool vtkUnstructuredGridBase_GetData_1(IntPtr /*(vtkUnstructuredGridBase**)*/ return_value, IntPtr /*(vtkInformationVector*)*/ v, int /*(int)*/ i);
