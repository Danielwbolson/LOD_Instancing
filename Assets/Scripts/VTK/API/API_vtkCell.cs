...
bool vtkCell_Initialize_0(IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ npts, IntPtr /*(vtkIdType*)*/ pts, IntPtr /*(vtkPoints*)*/ p);

// void Initialize(int npts, vtkPoints * p)
// void Initialize(int npts, vtkPoints *p)
[DllImport("vtkplugin", EntryPoint="vtkCell_Initialize_1")] public static extern 
bool vtkCell_Initialize_1(IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ npts, IntPtr /*(vtkPoints*)*/ p);

// virtual void ShallowCopy(vtkCell * c)
// virtual void ShallowCopy(vtkCell *c)
[DllImport("vtkplugin", EntryPoint="vtkCell_ShallowCopy_0")] public static extern 
bool vtkCell_ShallowCopy_0(IntPtr /*(vtkCell*)*/ callingObject, IntPtr /*(vtkCell*)*/ c);

// virtual void DeepCopy(vtkCell * c)
// virtual void DeepCopy(vtkCell *c)
[DllImport("vtkplugin", EntryPoint="vtkCell_DeepCopy_0")] public static extern 
bool vtkCell_DeepCopy_0(IntPtr /*(vtkCell*)*/ callingObject, IntPtr /*(vtkCell*)*/ c);

// virtual int GetCellType()
// virtual int GetCellType()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetCellType_0")] public static extern 
bool vtkCell_GetCellType_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetCellDimension()
// virtual int GetCellDimension()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetCellDimension_0")] public static extern 
bool vtkCell_GetCellDimension_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int IsLinear()
// virtual int IsLinear()
[DllImport("vtkplugin", EntryPoint="vtkCell_IsLinear_0")] public static extern 
bool vtkCell_IsLinear_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int RequiresInitialization()
// virtual int RequiresInitialization()
[DllImport("vtkplugin", EntryPoint="vtkCell_RequiresInitialization_0")] public static extern 
bool vtkCell_RequiresInitialization_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual void Initialize()
// virtual void Initialize()
[DllImport("vtkplugin", EntryPoint="vtkCell_Initialize_2")] public static extern 
bool vtkCell_Initialize_2(IntPtr /*(vtkCell*)*/ callingObject);

// virtual int IsExplicitCell()
// virtual int IsExplicitCell()
[DllImport("vtkplugin", EntryPoint="vtkCell_IsExplicitCell_0")] public static extern 
bool vtkCell_IsExplicitCell_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int RequiresExplicitFaceRepresentation()
// virtual int RequiresExplicitFaceRepresentation()
[DllImport("vtkplugin", EntryPoint="vtkCell_RequiresExplicitFaceRepresentation_0")] public static extern 
bool vtkCell_RequiresExplicitFaceRepresentation_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual vtkIdType* GetFaces()
// virtual vtkIdType *GetFaces()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetFaces_0")] public static extern 
bool vtkCell_GetFaces_0(IntPtr /*(vtkIdType**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkPoints* GetPoints()
// vtkPoints *GetPoints()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPoints_0")] public static extern 
bool vtkCell_GetPoints_0(IntPtr /*(vtkPoints**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdType GetNumberOfPoints()
// vtkIdType GetNumberOfPoints()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfPoints_0")] public static extern 
bool vtkCell_GetNumberOfPoints_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetNumberOfEdges()
// virtual int GetNumberOfEdges()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfEdges_0")] public static extern 
bool vtkCell_GetNumberOfEdges_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetNumberOfFaces()
// virtual int GetNumberOfFaces()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfFaces_0")] public static extern 
bool vtkCell_GetNumberOfFaces_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdList* GetPointIds()
// vtkIdList *GetPointIds()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPointIds_0")] public static extern 
bool vtkCell_GetPointIds_0(IntPtr /*(vtkIdList**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdType GetPointId(int ptId)
// vtkIdType GetPointId(int ptId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPointId_0")] public static extern 
bool vtkCell_GetPointId_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ ptId);

// virtual vtkCell* GetEdge(int edgeId)
// virtual vtkCell *GetEdge(int edgeId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetEdge_0")] public static extern 
bool vtkCell_GetEdge_0(IntPtr /*(vtkCell**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ edgeId);

// virtual vtkCell* GetFace(int faceId)
// virtual vtkCell *GetFace(int faceId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetFace_0")] public static extern 
bool vtkCell_GetFace_0(IntPtr /*(vtkCell**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ faceId);
...
bool vtkCell_CellBoundary_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(vtkIdList*)*/ pts);
...
bool vtkCell_EvaluatePosition_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(double*)*/ closestPoint, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double&)*/ dist2, IntPtr /*(double*)*/ weights);
...
bool vtkCell_EvaluateLocation_0(IntPtr /*(vtkCell*)*/ callingObject, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double /*(double[3])*/ []x, IntPtr /*(double*)*/ weights);
...
bool vtkCell_Derivatives_0(IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ values, int /*(int)*/ dim, IntPtr /*(double*)*/ derivs);

// void GetBounds(double bounds[6])
// void GetBounds(double bounds[6])
[DllImport("vtkplugin", EntryPoint="vtkCell_GetBounds_0")] public static extern 
bool vtkCell_GetBounds_0(IntPtr /*(vtkCell*)*/ callingObject, double /*(double[6])*/ []bounds);

// double* GetBounds()
// double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetBounds_1")] public static extern 
bool vtkCell_GetBounds_1(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// double GetLength2()
// double GetLength2()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetLength2_0")] public static extern 
bool vtkCell_GetLength2_0(IntPtr /*(double*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetParametricCenter(double pcoords[3])
// virtual int GetParametricCenter(double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricCenter_0")] public static extern 
bool vtkCell_GetParametricCenter_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// virtual double GetParametricDistance(double pcoords[3])
// virtual double GetParametricDistance(double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricDistance_0")] public static extern 
bool vtkCell_GetParametricDistance_0(IntPtr /*(double*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// virtual int IsPrimaryCell()
// virtual int IsPrimaryCell()
[DllImport("vtkplugin", EntryPoint="vtkCell_IsPrimaryCell_0")] public static extern 
bool vtkCell_IsPrimaryCell_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual double* GetParametricCoords()
// virtual double *GetParametricCoords()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricCoords_0")] public static extern 
bool vtkCell_GetParametricCoords_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);
