...
bool New_0(IntPtr /*(vtkXMLPolyDataReader**)*/ return_value);

// vtkPolyData* GetOutput()
// vtkPolyData *GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_GetOutput_0")] public static extern 
bool GetOutput_0(IntPtr /*(vtkPolyData**)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);

// vtkPolyData* GetOutput(int idx)
// vtkPolyData *GetOutput(int idx)
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_GetOutput_1")] public static extern 
bool GetOutput_1(IntPtr /*(vtkPolyData**)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject, int /*(int)*/ idx);
...
bool GetNumberOfVerts_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfLines_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfStrips_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfPolys_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
