...
bool GetMaximumCompressionSpace_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkDataCompressor*)*/ callingObject, ulong /*(size_t)*/ size);
...
bool Compress_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkDataCompressor*)*/ callingObject, IntPtr /*(charconst*)*/ uncompressedData, ulong /*(size_t)*/ uncompressedSize, IntPtr /*(char*)*/ compressedData, ulong /*(size_t)*/ compressionSpace);
...
bool Uncompress_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkDataCompressor*)*/ callingObject, IntPtr /*(charconst*)*/ compressedData, ulong /*(size_t)*/ compressedSize, IntPtr /*(char*)*/ uncompressedData, ulong /*(size_t)*/ uncompressedSize);
...
bool Compress_1(IntPtr /*(vtkUnsignedCharArray**)*/ return_value, IntPtr /*(vtkDataCompressor*)*/ callingObject, IntPtr /*(charconst*)*/ uncompressedData, ulong /*(size_t)*/ uncompressedSize);
...
bool Uncompress_1(IntPtr /*(vtkUnsignedCharArray**)*/ return_value, IntPtr /*(vtkDataCompressor*)*/ callingObject, IntPtr /*(charconst*)*/ compressedData, ulong /*(size_t)*/ compressedSize, ulong /*(size_t)*/ uncompressedSize);
