...
bool New_0(IntPtr /*(vtkXMLDataParser**)*/ return_value);

// vtkXMLDataElement* GetRootElement()
// vtkXMLDataElement* GetRootElement()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_GetRootElement_0")] public static extern 
bool GetRootElement_0(IntPtr /*(vtkXMLDataElement**)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool ReadInlineData_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(vtkXMLDataElement*)*/ element, int /*(int)*/ isAscii, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadInlineData_1(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(vtkXMLDataElement*)*/ element, int /*(int)*/ isAscii, IntPtr /*(char*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords);
...
bool ReadAppendedData_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, long /*(vtkTypeInt64)*/ offset, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadAppendedData_1(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, long /*(vtkTypeInt64)*/ offset, IntPtr /*(char*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords);
...
bool ReadAsciiData_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadBinaryData_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ maxWords, int /*(int)*/ wordType);
...
bool GetWordTypeSize_0(IntPtr /*(size_t*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, int /*(int)*/ wordType);

// int Parse()
// int Parse()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_Parse_0")] public static extern 
bool Parse_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);

// void CharacterDataHandler(const char * data, int length)
// void CharacterDataHandler(const char* data, int length)
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_CharacterDataHandler_0")] public static extern 
bool CharacterDataHandler_0(IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(char*)*/ data, int /*(int)*/ length);
...
bool GetAppendedDataPosition_0(IntPtr /*(vtkTypeInt64*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
