...
bool New_0(IntPtr /*(vtkIdTypeArray**)*/ return_value);

// int GetDataType()
// int GetDataType()
[DllImport("vtkplugin", EntryPoint="vtkIdTypeArray_GetDataType_0")] public static extern 
bool GetDataType_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkIdTypeArray*)*/ callingObject);
...
bool FastDownCast_0(IntPtr /*(vtkIdTypeArray**)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool GetDataTypeValueMin_0(IntPtr /*(vtkIdType*)*/ return_value);
...
bool GetDataTypeValueMax_0(IntPtr /*(vtkIdType*)*/ return_value);
