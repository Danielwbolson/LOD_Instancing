...
bool vtkGenericCell_New_0(IntPtr /*(vtkGenericCell**)*/ return_value);

// void SetPoints(vtkPoints * points)
// void SetPoints(vtkPoints *points)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetPoints_0")] public static extern 
bool vtkGenericCell_SetPoints_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(vtkPoints*)*/ points);

// void SetPointIds(vtkIdList * pointIds)
// void SetPointIds(vtkIdList *pointIds)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetPointIds_0")] public static extern 
bool vtkGenericCell_SetPointIds_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(vtkIdList*)*/ pointIds);

// void ShallowCopy(vtkCell * c)
// void ShallowCopy(vtkCell *c)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_ShallowCopy_0")] public static extern 
bool vtkGenericCell_ShallowCopy_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(vtkCell*)*/ c);

// void DeepCopy(vtkCell * c)
// void DeepCopy(vtkCell *c)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_DeepCopy_0")] public static extern 
bool vtkGenericCell_DeepCopy_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(vtkCell*)*/ c);

// int GetCellType()
// int GetCellType()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetCellType_0")] public static extern 
bool vtkGenericCell_GetCellType_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetCellDimension()
// int GetCellDimension()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetCellDimension_0")] public static extern 
bool vtkGenericCell_GetCellDimension_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int IsLinear()
// int IsLinear()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_IsLinear_0")] public static extern 
bool vtkGenericCell_IsLinear_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int RequiresInitialization()
// int RequiresInitialization()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_RequiresInitialization_0")] public static extern 
bool vtkGenericCell_RequiresInitialization_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// void Initialize()
// void Initialize()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_Initialize_0")] public static extern 
bool vtkGenericCell_Initialize_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_RequiresExplicitFaceRepresentation_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// void SetFaces(vtkIdType * faces)
// void SetFaces(vtkIdType *faces)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetFaces_0")] public static extern 
bool vtkGenericCell_SetFaces_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(vtkIdType*)*/ faces);

// vtkIdType* GetFaces()
// vtkIdType *GetFaces()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetFaces_0")] public static extern 
bool vtkGenericCell_GetFaces_0(IntPtr /*(vtkIdType**)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetNumberOfEdges()
// int GetNumberOfEdges()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetNumberOfEdges_0")] public static extern 
bool vtkGenericCell_GetNumberOfEdges_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetNumberOfFaces()
// int GetNumberOfFaces()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetNumberOfFaces_0")] public static extern 
bool vtkGenericCell_GetNumberOfFaces_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// vtkCell* GetEdge(int edgeId)
// vtkCell *GetEdge(int edgeId)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetEdge_0")] public static extern 
bool vtkGenericCell_GetEdge_0(IntPtr /*(vtkCell**)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ edgeId);

// vtkCell* GetFace(int faceId)
// vtkCell *GetFace(int faceId)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetFace_0")] public static extern 
bool vtkGenericCell_GetFace_0(IntPtr /*(vtkCell**)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ faceId);

// int CellBoundary(int subId, double pcoords[3], vtkIdList * pts)
// int CellBoundary(int subId, double pcoords[3], vtkIdList *pts)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_CellBoundary_0")] public static extern 
bool vtkGenericCell_CellBoundary_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(vtkIdList*)*/ pts);

// int EvaluatePosition(double x[3], double * closestPoint, int & subId, double pcoords[3], double & dist2, double * weights)
// int EvaluatePosition(double x[3], double* closestPoint, int& subId, double pcoords[3], double& dist2, double *weights)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_EvaluatePosition_0")] public static extern 
bool vtkGenericCell_EvaluatePosition_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(double*)*/ closestPoint, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double&)*/ dist2, IntPtr /*(double*)*/ weights);

// void EvaluateLocation(int & subId, double pcoords[3], double x[3], double * weights)
// void EvaluateLocation(int& subId, double pcoords[3], double x[3], double *weights)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_EvaluateLocation_0")] public static extern 
bool vtkGenericCell_EvaluateLocation_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double /*(double[3])*/ []x, IntPtr /*(double*)*/ weights);
...
bool vtkGenericCell_Clip_0(IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double)*/ value, IntPtr /*(vtkDataArray*)*/ cellScalars, IntPtr /*(vtkIncrementalPointLocator*)*/ locator, IntPtr /*(vtkCellArray*)*/ connectivity, IntPtr /*(vtkPointData*)*/ inPd, IntPtr /*(vtkPointData*)*/ outPd, IntPtr /*(vtkCellData*)*/ inCd, long /*(vtkIdType)*/ cellId, IntPtr /*(vtkCellData*)*/ outCd, int /*(int)*/ insideOut);

// int IntersectWithLine(double p1[3], double p2[3], double tol, double & t, double x[3], double pcoords[3], int & subId)
// int IntersectWithLine(double p1[3], double p2[3], double tol, double& t, double x[3], double pcoords[3], int& subId)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_IntersectWithLine_0")] public static extern 
bool vtkGenericCell_IntersectWithLine_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []p1, double /*(double[3])*/ []p2, double /*(double)*/ tol, IntPtr /*(double&)*/ t, double /*(double[3])*/ []x, double /*(double[3])*/ []pcoords, IntPtr /*(int&)*/ subId);

// int Triangulate(int index, vtkIdList * ptIds, vtkPoints * pts)
// int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_Triangulate_0")] public static extern 
bool vtkGenericCell_Triangulate_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ index, IntPtr /*(vtkIdList*)*/ ptIds, IntPtr /*(vtkPoints*)*/ pts);

// void Derivatives(int subId, double pcoords[3], double * values, int dim, double * derivs)
// void Derivatives(int subId, double pcoords[3], double *values, int dim, double *derivs)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_Derivatives_0")] public static extern 
bool vtkGenericCell_Derivatives_0(IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ values, int /*(int)*/ dim, IntPtr /*(double*)*/ derivs);

// int GetParametricCenter(double pcoords[3])
// int GetParametricCenter(double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetParametricCenter_0")] public static extern 
bool vtkGenericCell_GetParametricCenter_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// double* GetParametricCoords()
// double *GetParametricCoords()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetParametricCoords_0")] public static extern 
bool vtkGenericCell_GetParametricCoords_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int IsPrimaryCell()
// int IsPrimaryCell()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_IsPrimaryCell_0")] public static extern 
bool vtkGenericCell_IsPrimaryCell_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_InterpolateFunctions_0(IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []pcoords, IntPtr /*(double*)*/ weights);
...
bool vtkGenericCell_SetCellTypeToPentagonalPrism_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToHexagonalPrism_0(IntPtr /*(vtkGenericCell*)*/ callingObject);

// void SetCellTypeToPolyhedron()
// void SetCellTypeToPolyhedron()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetCellTypeToPolyhedron_0")] public static extern 
bool vtkGenericCell_SetCellTypeToPolyhedron_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToConvexPointSet_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticEdge_0(IntPtr /*(vtkGenericCell*)*/ callingObject);

// void SetCellTypeToCubicLine()
// void SetCellTypeToCubicLine()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetCellTypeToCubicLine_0")] public static extern 
bool vtkGenericCell_SetCellTypeToCubicLine_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticTriangle_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToBiQuadraticTriangle_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticQuad_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticPolygon_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticTetra_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticHexahedron_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticWedge_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticPyramid_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticLinearQuad_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToBiQuadraticQuad_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToQuadraticLinearWedge_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToBiQuadraticQuadraticWedge_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToTriQuadraticHexahedron_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToBiQuadraticQuadraticHexahedron_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeTriangle_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeTetra_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeCurve_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeQuadrilateral_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeHexahedron_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_SetCellTypeToLagrangeWedge_0(IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool vtkGenericCell_InstantiateCell_0(IntPtr /*(vtkCell**)*/ return_value, int /*(int)*/ cellType);

// vtkCell* GetRepresentativeCell()
// vtkCell* GetRepresentativeCell()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetRepresentativeCell_0")] public static extern 
bool vtkGenericCell_GetRepresentativeCell_0(IntPtr /*(vtkCell**)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
