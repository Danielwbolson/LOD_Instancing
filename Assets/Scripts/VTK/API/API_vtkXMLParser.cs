...
bool New_0(IntPtr /*(vtkXMLParser**)*/ return_value);

// vtkTypeInt64 TellG()
// vtkTypeInt64 TellG()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_TellG_0")] public static extern 
bool TellG_0(IntPtr /*(vtkTypeInt64*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
...
bool Parse_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);

// virtual int Parse(const char * inputString)
// virtual int Parse(const char* inputString)
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_Parse_1")] public static extern 
bool Parse_1(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, IntPtr /*(char*)*/ inputString);
...
bool Parse_2(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, IntPtr /*(char*)*/ inputString, uint /*(int)*/ length);

// virtual int InitializeParser()
// virtual int InitializeParser()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_InitializeParser_0")] public static extern 
bool InitializeParser_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);

// virtual int ParseChunk(const char * inputString, unsigned int length)
// virtual int ParseChunk(const char* inputString, unsigned int length)
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_ParseChunk_0")] public static extern 
bool ParseChunk_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, IntPtr /*(char*)*/ inputString, uint /*(int)*/ length);

// virtual int CleanupParser()
// virtual int CleanupParser()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_CleanupParser_0")] public static extern 
bool CleanupParser_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
