...
bool vtkAbstractPointLocator_FindClosestPoint_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double[3])*/ []x);

// vtkIdType FindClosestPoint(double x, double y, double z)
// vtkIdType FindClosestPoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkAbstractPointLocator_FindClosestPoint_1")] public static extern 
bool vtkAbstractPointLocator_FindClosestPoint_1(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool vtkAbstractPointLocator_FindClosestPointWithinRadius_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ radius, double /*(double[3])*/ []x, IntPtr /*(double&)*/ dist2);
...
bool vtkAbstractPointLocator_FindClosestNPoints_0(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, int /*(int)*/ N, double /*(double[3])*/ []x, IntPtr /*(vtkIdList*)*/ result);
...
bool vtkAbstractPointLocator_FindClosestNPoints_1(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, int /*(int)*/ N, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z, IntPtr /*(vtkIdList*)*/ result);
...
bool vtkAbstractPointLocator_FindPointsWithinRadius_0(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ R, double /*(double[3])*/ []x, IntPtr /*(vtkIdList*)*/ result);
...
bool vtkAbstractPointLocator_FindPointsWithinRadius_1(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ R, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z, IntPtr /*(vtkIdList*)*/ result);

// virtual double* GetBounds()
// virtual double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPointLocator_GetBounds_0")] public static extern 
bool vtkAbstractPointLocator_GetBounds_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject);
...
bool vtkAbstractPointLocator_GetBounds_1(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, IntPtr /*(double*)*/ ARG_0);
