...
bool vtkLookupTable_SetTableRange_0(IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double[2])*/ []r);

// virtual void SetTableRange(double min, double max)
// virtual void SetTableRange(double min, double max)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_SetTableRange_1")] public static extern 
bool vtkLookupTable_SetTableRange_1(IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ min, double /*(double)*/ max);
...
bool vtkLookupTable_GetNanColorAsUnsignedChars_0(IntPtr /*(char**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject);
...
bool vtkLookupTable_GetColorAsUnsignedChars_0(double /*(double[4])*/ []colorIn, char /*(char[4])*/ []colorOut);

// char* MapValue(double v)
// unsigned char* MapValue(double v)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_MapValue_0")] public static extern 
bool vtkLookupTable_MapValue_0(IntPtr /*(char**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ v);

// void GetColor(double x, double rgb[3])
// void GetColor(double x, double rgb[3])
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetColor_0")] public static extern 
bool vtkLookupTable_GetColor_0(IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ x, double /*(double[3])*/ []rgb);

// double GetOpacity(double v)
// double GetOpacity(double v)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetOpacity_0")] public static extern 
bool vtkLookupTable_GetOpacity_0(IntPtr /*(double*)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ v);

// virtual vtkIdType GetIndex(double v)
// virtual vtkIdType GetIndex(double v)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetIndex_0")] public static extern 
bool vtkLookupTable_GetIndex_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ v);

// void SetNumberOfTableValues(vtkIdType number)
// void SetNumberOfTableValues(vtkIdType number)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_SetNumberOfTableValues_0")] public static extern 
bool vtkLookupTable_SetNumberOfTableValues_0(IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ number);

// vtkIdType GetNumberOfTableValues()
// vtkIdType GetNumberOfTableValues()
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetNumberOfTableValues_0")] public static extern 
bool vtkLookupTable_GetNumberOfTableValues_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject);
...
bool vtkLookupTable_SetTableValue_0(IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ indx, double /*(double[4])*/ []rgba);

// double* GetTableValue(vtkIdType id)
// double *GetTableValue(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetTableValue_0")] public static extern 
bool vtkLookupTable_GetTableValue_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ id);
...
bool vtkLookupTable_GetTableValue_1(IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ id, double /*(double[4])*/ []rgba);

// char* GetPointer(vtkIdType id)
// unsigned char *GetPointer(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetPointer_0")] public static extern 
bool vtkLookupTable_GetPointer_0(IntPtr /*(char**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ id);
...
bool vtkLookupTable_WritePointer_0(IntPtr /*(char**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ id, int /*(int)*/ number);

// double* GetRange()
// double *GetRange()
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_GetRange_0")] public static extern 
bool vtkLookupTable_GetRange_0(IntPtr /*(double**)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject);

// void SetRange(double min, double max)
// void SetRange(double min, double max)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_SetRange_0")] public static extern 
bool vtkLookupTable_SetRange_0(IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double)*/ min, double /*(double)*/ max);

// void SetRange(const double rng[2])
// void SetRange(const double rng[2])
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_SetRange_1")] public static extern 
bool vtkLookupTable_SetRange_1(IntPtr /*(vtkLookupTable*)*/ callingObject, double /*(double[2])*/ []rng);
...
bool vtkLookupTable_GetLogRange_0(double /*(double[2])*/ []range, double /*(double[2])*/ []log_range);
...
bool vtkLookupTable_ApplyLogScale_0(IntPtr /*(double*)*/ return_value, double /*(double)*/ v, double /*(double[2])*/ []range, double /*(double[2])*/ []log_range);
...
bool vtkLookupTable_SetTable_0(IntPtr /*(vtkLookupTable*)*/ callingObject, IntPtr /*(vtkUnsignedCharArray*)*/ ARG_0);
...
bool vtkLookupTable_MapScalarsThroughTable2_0(IntPtr /*(vtkLookupTable*)*/ callingObject, IntPtr /*(void*)*/ input, IntPtr /*(char*)*/ output, int /*(int)*/ inputDataType, int /*(int)*/ numberOfValues, int /*(int)*/ inputIncrement, int /*(int)*/ outputIncrement);

// void DeepCopy(vtkScalarsToColors * lut)
// void DeepCopy(vtkScalarsToColors *lut)
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_DeepCopy_0")] public static extern 
bool vtkLookupTable_DeepCopy_0(IntPtr /*(vtkLookupTable*)*/ callingObject, IntPtr /*(vtkScalarsToColors*)*/ lut);

// int UsingLogScale()
// int UsingLogScale()
[DllImport("vtkplugin", EntryPoint="vtkLookupTable_UsingLogScale_0")] public static extern 
bool vtkLookupTable_UsingLogScale_0(IntPtr /*(int*)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject);
...
bool vtkLookupTable_GetNumberOfAvailableColors_0(IntPtr /*(vtkIdType*)*/ return_value, IntPtr /*(vtkLookupTable*)*/ callingObject);
...
bool vtkLookupTable_GetIndexedColor_0(IntPtr /*(vtkLookupTable*)*/ callingObject, long /*(vtkIdType)*/ idx, double /*(double[4])*/ []rgba);
