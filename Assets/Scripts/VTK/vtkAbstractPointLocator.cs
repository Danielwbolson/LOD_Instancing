...
public long FindClosestPoint(double /*(double[3])*/ []x) {
	...
	API_vtkAbstractPointLocator.FindClosestPoint_0(returnPointer.GetPtr(), this, x);
...
public long FindClosestPoint(double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkAbstractPointLocator.FindClosestPoint_1(returnPointer.GetPtr(), this, x, y, z);
	return (long)returnPointer;
}
...
public long FindClosestPointWithinRadius(double /*(double)*/ radius, double /*(double[3])*/ []x, IntPtr /*(double&)*/ dist2) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkAbstractPointLocator.FindClosestPointWithinRadius_0(returnPointer.GetPtr(), this, radius, x, dist2);
	return (long)returnPointer;
}
...
public IntPtr GetBounds() {
	...
	API_vtkAbstractPointLocator.GetBounds_0(returnPointer.GetPtr(), this);
