...
public static vtkDataArray FastDownCast(vtkAbstractArray /*(vtkAbstractArray*)*/ source) {
	...
	API_vtkDataArray.FastDownCast_0(returnPointer.GetPtr(), source);
...
public int IsNumeric() {
	...
	API_vtkDataArray.IsNumeric_0(returnPointer.GetPtr(), this);
...
public int GetElementComponentSize() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkDataArray.GetElementComponentSize_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
...
public long InsertNextTuple(long /*(vtkIdType)*/ srcTupleIdx, vtkAbstractArray /*(vtkAbstractArray*)*/ source) {
	...
	API_vtkDataArray.InsertNextTuple_0(returnPointer.GetPtr(), this, srcTupleIdx, source);
...
public IntPtr GetTuple(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple_0(returnPointer.GetPtr(), this, tupleIdx);
...
public double GetTuple1(long /*(vtkIdType)*/ tupleIdx) {
	...
	API_vtkDataArray.GetTuple1_0(returnPointer.GetPtr(), this, tupleIdx);
...
public IntPtr GetTuple2(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple2_0(returnPointer.GetPtr(), this, tupleIdx);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetTuple3(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple3_0(returnPointer.GetPtr(), this, tupleIdx);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetTuple4(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple4_0(returnPointer.GetPtr(), this, tupleIdx);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetTuple6(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple6_0(returnPointer.GetPtr(), this, tupleIdx);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetTuple9(long /*(vtkIdType)*/ tupleIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetTuple9_0(returnPointer.GetPtr(), this, tupleIdx);
	return (IntPtr)returnPointer;
}
...
public long InsertNextTuple(IntPtr /*(float*)*/ tuple) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new long(), return_elements);
	API_vtkDataArray.InsertNextTuple_1(returnPointer.GetPtr(), this, tuple);
	return (long)returnPointer;
}
...
public double GetComponent(long /*(vtkIdType)*/ tupleIdx, int /*(int)*/ compIdx) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetComponent_0(returnPointer.GetPtr(), this, tupleIdx, compIdx);
	return (double)returnPointer;
}
...
public IntPtr WriteVoidPointer(long /*(vtkIdType)*/ valueIdx, long /*(vtkIdType)*/ numValues) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.WriteVoidPointer_0(returnPointer.GetPtr(), this, valueIdx, numValues);
	return (IntPtr)returnPointer;
}
...
public ulong GetActualMemorySize() {
	...
	API_vtkDataArray.GetActualMemorySize_0(returnPointer.GetPtr(), this);
...
public IntPtr GetRange(int /*(int)*/ comp) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetRange_1(returnPointer.GetPtr(), this, comp);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetRange() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetRange_2(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetFiniteRange(int /*(int)*/ comp) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetFiniteRange_1(returnPointer.GetPtr(), this, comp);
	return (IntPtr)returnPointer;
}
...
public IntPtr GetFiniteRange() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr(), return_elements);
	API_vtkDataArray.GetFiniteRange_2(returnPointer.GetPtr(), this);
	return (IntPtr)returnPointer;
}
...
public double GetDataTypeMin() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetDataTypeMin_0(returnPointer.GetPtr(), this);
	return (double)returnPointer;
}
...
public double GetDataTypeMax() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetDataTypeMax_0(returnPointer.GetPtr(), this);
	return (double)returnPointer;
}
...
public static double GetDataTypeMin(int /*(int)*/ type) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetDataTypeMin_1(returnPointer.GetPtr(), type);
	return (double)returnPointer;
}
...
public static double GetDataTypeMax(int /*(int)*/ type) {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetDataTypeMax_1(returnPointer.GetPtr(), type);
	return (double)returnPointer;
}
...
public double GetMaxNorm() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new double(), return_elements);
	API_vtkDataArray.GetMaxNorm_0(returnPointer.GetPtr(), this);
	return (double)returnPointer;
}
...
public int GetArrayType() {
	int return_elements = 1;
	ReturnPointer returnPointer = new ReturnPointer(new int(), return_elements);
	API_vtkDataArray.GetArrayType_0(returnPointer.GetPtr(), this);
	return (int)returnPointer;
}
